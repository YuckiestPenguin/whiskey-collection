...
class WhiskeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create whiskey" do
    assert_difference('Whiskey.count') do
      post whiskeys_url, params: { whiskey: { abv: @whiskey.abv, color: @whiskey.color, finish: @whiskey.finish, nose: @whiskey.nose, overall: @whiskey.overall, price: @whiskey.price, score: @whiskey.score, taste: @whiskey.taste, title: @whiskey.title } }
    end
  ...
  test "should update whiskey" do
    patch whiskey_url(@whiskey), params: { whiskey: { abv: @whiskey.abv, color: @whiskey.color, finish: @whiskey.finish, nose: @whiskey.nose, overall: @whiskey.overall, price: @whiskey.price, score: @whiskey.score, taste: @whiskey.taste, title: @whiskey.title } }
